...
are fully specified in [admin-model.md](admin-model.md), which covers lifecycle, creation,
bootstrap, the self-grant flow, service accounts, and audit integrity.
